...
### Version 1.0.2 (02.12.2025)
- ✅ Добавлено версионирование CSS/JS файлов (cache busting)
- ✅ Улучшена обработка камеры для HTTP с детальными сообщениями об ошибках
- ✅ Добавлен пункт "Тестовые данные" в настройках для редактирования стенограммы
- ✅ Тестовые данные теперь сохраняются в БД (таблица `test_data`)
- ✅ Исправлен Dockerfile для корректной работы с БД при деплое
- ✅ Mock-transcription использует данные из БД с fallback на файл
