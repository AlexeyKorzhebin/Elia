...
| [FEATURES_V1.0.2.md](FEATURES_V1.0.2.md) | Новые функции версии 1.0.2 |
...
- ✅ Добавлено версионирование CSS/JS файлов (cache busting)
- ✅ Улучшена обработка камеры для HTTP с инструкциями
- ✅ Добавлен пункт "Тестовые данные" в настройках
- ✅ Тестовые данные сохраняются в БД
- ✅ Исправлен Dockerfile для корректной работы с БД
- ✅ Добавлена документация по доступу к камере
